...
@section('content')
    ...
    <div class="bodybox">
        <a href="{{url('operate/flight')}}" id="tab1" class="tab1"></a>
        <a href="{{url('operate/topo')}}" id="tab2" class="tab2 tab2_"></a>
                        ...
                        <ul>
                            @foreach($deviceInfos as $deviceInfo)
                                <li class="{{$deviceInfo->DevStatus==2 ? '' : 'ror'}}">
                                    <a href="#" onclick="{{$deviceInfo->DevStatus==2 ? "javascript:void(0);" : "layerMessage()"}}">
                                        <i></i>
