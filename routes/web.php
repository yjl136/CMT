...
Route::get('/showDevice/{mac}/alarm/{alarm_level?}/{clear_status?}/{start_time?}/{end_time?}','DeviceController@deviceAlarmInfo');
...
Route::get('/maintenance/showDevice/{mac}/alarm/{alarm_level?}/{clear_status?}/{start_time?}/{end_time?}','MaintenanceController@deviceAlarmInfo');
